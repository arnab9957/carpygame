# This file contains the fixed implementation for fullscreen mode

def apply_setting_fixed(self, option):
    """Fixed implementation of apply_setting for SettingsMenu and PauseMenu classes"""
