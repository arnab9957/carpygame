...
SCREEN_WIDTH = min(info.current_w - 100, 1024)  # Limit max resolution
SCREEN_HEIGHT = min(info.current_h - 100, 768)  # Limit max resolution
...
class HighScoreManager:
    def __init__(self, filename="highscores.json"):
        ...
        self.highscores = {"endless": [], "time_attack": [], "missions": []}
    ...
    def load_highscores(self):
        ...
        try:
            if os.path.exists(self.filename):
                ...
                for key in ["endless", "time_attack", "missions"]:
...
class Game:
    ...
    def reset_game(self):
        ...
        self.mission_type = random.randint(
            0, 4
    ...
    def track_avoided_obstacle(self, obstacle):
        ...
        try:
            ...
            for event in pygame.event.get():
                ...
                # Handle window resize
                    ...
                    try:
                        # Handle resize with our new method
    ...
    def show_menu(self):
        ...
        options = [
            ...
            ("GARAGE", NEON_GREEN, -5),  # Added Garage option with key code -5
    ...
    def show_garage_menu(self, background_surface):
        ...
        # Create car images - using the same car design as in the game, just with different colors
        car_images = []
        for car in cars:
            ...
            # Draw the car body (same design as player car)
            car_body_width = car_width * 0.8
            car_body_height = car_height * 0.6
            car_body_x = (car_width - car_body_width) / 2
            car_body_y = (car_height - car_body_height) / 2
            
            # Car body with the selected color
            pygame.draw.rect(
                img,
                car["color"],
            ...
            # Add metallic effect with gradient
            highlight_color = (
                min(car["color"][0] + 40, 255),
                min(car["color"][1] + 40, 255),
                min(car["color"][2] + 40, 255),
            )
            pygame.draw.rect(
                img,
                highlight_color,
                [car_body_x, car_body_y, car_body_width // 2, car_body_height],
                0,
                10
            )
            
            # Windshield
            windshield_width = int(car_body_width * 0.8)
            windshield_height = int(car_body_height * 0.3)
            windshield_x = car_body_x + (car_body_width - windshield_width) / 2
            windshield_y = car_body_y + int(car_body_height * 0.15)
            pygame.draw.rect(
                img,
            ...
            # Wheels
            wheel_width = int(car_width * 0.15)
            wheel_height = int(car_height * 0.15)
            
            # Front left wheel
            pygame.draw.rect(
                img,
                BLACK,
                [car_body_x - 3, car_body_y + car_body_height * 0.25, wheel_width, wheel_height],
                0,
                3
            )
            ...
            pygame.draw.rect(
                img,
                BLACK,
                [car_body_x + car_body_width - wheel_width + 3, car_body_y + car_body_height * 0.25, wheel_width, wheel_height],
                0,
                3
            )
            ...
            pygame.draw.rect(
                img,
                BLACK,
                [car_body_x - 3, car_body_y + car_body_height * 0.75 - wheel_height, wheel_width, wheel_height],
                0,
                3
            )
            ...
            pygame.draw.rect(
                img,
                BLACK,
                [car_body_x + car_body_width - wheel_width + 3, car_body_y + car_body_height * 0.75 - wheel_height, wheel_width, wheel_height],
                0,
                3
            )
            ...
            headlight_height = int(car_height * 0.08)
            
            # Left headlight
            pygame.draw.rect(
                img,
                NEON_YELLOW,
                [car_body_x + 5, car_body_y + 5, headlight_width, headlight_height],
                0,
                3
            )
            ...
            pygame.draw.rect(
                img,
                NEON_YELLOW,
                [car_body_x + car_body_width - headlight_width - 5, car_body_y + 5, headlight_width, headlight_height],
                0,
                3
            )
        ...
        while running:
            ...
            for i, (text, color, mode) in enumerate(options):
                ...
                if is_hovering:
                    ...
                    option_text = menu_font.render(text, True, color)
                    pygame.draw.rect(
                        self.screen, color, button_rect, 2, border_radius=10
                    )
                    
                    # Create text with original color
                    option_text = menu_font.render(text, True, color)
