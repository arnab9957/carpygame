...
STAR_COUNT = 100  # Number of stars in the night sky
...
class ParticleSystem:
    ...
    def create_crash(self, x: float, y: float) -> None:
        ...
        self.create_spark(x, y, count=50, intensity=1.5)

        # Create smoke with different colors for a more dramatic effect
        self.create_smoke(x, y, count=15)  # Regular gray smoke
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    ...
                    if (
                        self.settings[option] is not None
                        and self.current_values[option] > 0
                    ):
                        ...
                        if sound_enabled:
                            sound_menu_navigate.play()
                        # Return special result if fullscreen changed
                        if option == "FULLSCREEN" and result == "FULLSCREEN_CHANGED":
                            return "FULLSCREEN_CHANGED"
                elif event.key == pygame.K_RIGHT:
                    option = self.options[self.selected_option]
                    if (
                        self.settings[option] is not None
                        and self.current_values[option] < len(self.settings[option]) - 1
                    ):
                        self.current_values[option] += 1
                        result = self.apply_setting(option)
                        # Play menu navigation sound
...
class PromptSystem:
    ...
    def __init__(self, screen):
        ...
        self.active_prompts = []
        self.font = pygame.font.SysFont("arial", scale_value(24), bold=True)
        self.small_font = pygame.font.SysFont("arial", scale_value(18))
...
class Game:
    def __init__(self):
        try:
            ...
            self.font = pygame.font.SysFont(None, scale_value(36))
            self.font_large = pygame.font.SysFont("arial", scale_value(48), bold=True)
            self.font_medium = pygame.font.SysFont("arial", scale_value(36), bold=True)
            self.font_small = pygame.font.SysFont("arial", scale_value(24))
    ...
    def generate_sparkles(self, count):
    ...
    def show_name_input(self):
        ...
        while not done:
            ...
            # Draw instructions
            instruction_text = pygame.font.SysFont("arial", 24).render(
        ...
        try:
            ...
            if hasattr(self, "crash_animation_timer"):
                ...
                if 0.3 < progress < 0.9:
                    ...
                    crash_font = pygame.font.SysFont("arial", text_size, bold=True)
            ...
            for i, (text, color, key) in enumerate(options):
                ...
                if is_hovering:
                    ...
                    for offset in range(5, 0, -1):
                        ...
                        glow_rect.inflate_ip(offset * pulse, offset * pulse)
                        pygame.draw.rect(
                            self.screen, hover_color, glow_rect, 2, border_radius=10
                        )

                    # Draw button
                    pygame.draw.rect(
                        self.screen, DEEP_BLUE, button_rect, border_radius=10
                    )
                    pygame.draw.rect(
                        self.screen, hover_color, button_rect, 2, border_radius=10
                    )
        ...
        while running:
            ...
            for i, (text, color, mode) in enumerate(options):
                ...
                if is_hovering:
                    ...
                    # Draw glowing borders with pulse effect
                    for offset in range(5, 0, -1):
                        glow_rect = button_rect.copy()
                        glow_rect.inflate_ip(offset * pulse, offset * pulse)
                        pygame.draw.rect(
            ...
            # Draw instructions
            instructions_text = pygame.font.SysFont("arial", 24).render(
